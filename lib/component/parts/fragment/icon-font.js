...
class IconFont extends fr.Nel {
     ...
     */
    constructor(o = {}) {
        const c = (o.class) ? [ ...o.class ] : []
        c.push(o.family ?? "material-symbols-outlined");

        const attrs = {
            class: [ ...c ],
            style: {
                "cursor": (o.clickable) ? "pointer" : "default",
                "font-size": o.size ?? "48px",
...
const createIconFont = (o = {}) => {
    ...
    //     }
    // }
    // attrs["class"].push(o.family ?? "material-symbols-outlined");
    // console.log(attrs);
    // return new fr.Nel(1, "span", attrs, o.icon_name)
